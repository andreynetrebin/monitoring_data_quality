...
def create_directory(directory_path):
    ...
    try:
        ...
        logging.info(f"Директория '{directory_path}' успешно создана или уже существует.")
    except Exception as e:
        logging.error(f"Ошибка при создании директории '{directory_path}': {e}")
...
def clear_directory(directory_path):
    ...
    try:
        if os.path.exists(directory_path) and os.path.isdir(directory_path):
            ...
            logging.info(f"Директория '{directory_path}' успешно очищена.")
        else:
            logging.warning(f"Директория '{directory_path}' не существует.")
    except Exception as e:
        logging.error(f"Ошибка при очистке директории '{directory_path}': {e}")
